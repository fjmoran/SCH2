...
<h4>Últimos gastos ingresados</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Ingreso de Gasto</h4>
      </div>
      <form role="form">
        <div class="modal-body">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="adj">
              ...
              <div class="row" id="row_boleta[0]" style="background-color:lightgray; padding-top:5px; margin:0px; -webkit-border-radius: 5px 5px 0 0 !important; -moz-border-radius: 5px 5px 0 0 !important; border-radius: 5px 5px 0 0 !important;">
                <div class="col-md-6">
                  <div class="form-group"> 
...
<div id="editar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editarLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">Edición de Gasto</h4>
      </div>
      <form role="form">
        <div class="modal-body">
          <div class="row">
