...
$SSQL="SELECT idUsuario, userUsuario,nombreUsuario,Perfil_idPerfil FROM SCH2.Usuario WHERE Usuario.userUsuario='".$_POST['user']."' and Usuario.claveUsuario='".$_POST['password']."'";
