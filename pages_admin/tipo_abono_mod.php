...
$campos_busqueda = array("Nombre"=>"nombreTipoAbono","Descripción"=>"descripcionTipoAbono");
...
<div class="col-md-11">
	...
	<?php
		...
		if ($_GET['tampag'] < $total){
			echo paginar($_GET['pagina'],$total,$_GET['tampag'],"pages_admin/tipo_abono_mod.php?".http_build_query($_GET)."&tampag=".$_GET['tampag']."&pagina=","#tipo_abono_mod");
		}
	?>
	</div>
