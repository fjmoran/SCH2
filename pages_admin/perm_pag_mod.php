...
$campos_busqueda = array("Pagina"=>"Pagina_idPagina","Rol"=>"Perfil_idPerfil");
...
<div class="col-md-11">
	...
	<?php
		...
		if ($_GET['tampag'] < $total){
			echo paginar($_GET['pagina'],$total,$_GET['tampag'],"pages_admin/usr_perm_pag.php?".http_build_query($_GET)."&tampag=".$_GET['tampag']."&pagina=","#perm_pag_mod");
		}
	?>
	</div>
