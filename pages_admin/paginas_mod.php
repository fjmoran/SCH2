...
$campos_busqueda = array("URL"=>"urlPagina","Página"=>"nombrePagina","Descripción"=>"descripcionPagina");
...
<div class="col-md-11">
	...
	<?php
		...
		if ($_GET['tampag'] < $total){
			echo paginar($_GET['pagina'],$total,$_GET['tampag'],"pages_admin/paginas_mod.php?".http_build_query($_GET)."&tampag=".$_GET['tampag']."&pagina=","#paginas_mod");
		}
	?>
	</div>
