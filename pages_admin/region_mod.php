...
$campos_busqueda = array("País"=>"Pais_idPais","Región"=>"nombreRegion","Codigo"=>"codeRegion");
...
<div class="col-md-11">
	...
	$_GET['orderby'] = "activoRegion DESC, Pais_idPais, codeRegion";
	...
	<?php
		...
		if ($_GET['tampag'] < $total){
			echo paginar($_GET['pagina'],$total,$_GET['tampag'],"pages_admin/region_mod.php?".http_build_query($_GET)."&tampag=".$_GET['tampag']."&pagina=","#region_mod");
		}
	?>
	</div>
