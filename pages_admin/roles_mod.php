...
$campos_busqueda = array("Nombre"=>"nombrePerfil","Descripción"=>"descripcionPerfil");
...
<div class="col-md-11">
	...
	<?php
		...
		if ($_GET['tampag'] < $total){
			echo paginar($_GET['pagina'],$total,$_GET['tampag'],"pages_admin/roles_mod.php?".http_build_query($_GET)."&tampag=".$_GET['tampag']."&pagina=","#roles_mod");
		}
	?>
	</div>
